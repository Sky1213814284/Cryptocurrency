...
comments = {
	...
	'suggestions': "Should be more clear in description and there is a bug in the provided code which bothered a lot of students for a long time.",
